...
load('/brain/iCAN_admin/home/tianting/script/seed_whole_brain/get_roivalue_after_whole_brain_fc/50database.mat');%��ı���database

%%%% ROI %%%%%%    
  mask=strcat('/brain/iCAN_admin/home/tianting/lcmvmpfc_0005_45.img');%��Ҫ��ֵ����һ��mask
%it can be nii or img, you can use mriclone to convert img into nii file.
    ...
    for i=1:50
        out_f=strcat('/brain/iCAN_admin/home/tianting/result/seed_wholebrain_rs/par_amy/par_cm_bl/',Database{i});%data·��
        cd(out_f);
